<?php get_header(); ?>
    ...
    <div class="gallary row">
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-1.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-2.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-3.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-4.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-5.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-6.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-7.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-8.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-9.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-10.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-11.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
        ...
        <div class="col-sm-6 col-lg-3 gallary-item wow fadeIn">
            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/gallary-12.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card bg-transparent border my-3 my-md-0">
                            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/blog-1.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
                    ...
                    <div class="col-md-4">
                        <div class="card bg-transparent border my-3 my-md-0">
                            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/blog-2.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
                    ...
                    <div class="col-md-4">
                        <div class="card bg-transparent border my-3 my-md-0">
                            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/blog-3.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
                ...
                <div class="row">
                    <div class="col-md-4 my-3 my-md-0">
                        <div class="card bg-transparent border">
                            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/blog-4.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
                    ...
                    <div class="col-md-4 my-3 my-md-0">
                        <div class="card bg-transparent border">
                            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/blog-5.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
                    ...
                    <div class="col-md-4 my-3 my-md-0">
                        <div class="card bg-transparent border">
                            <img src= "<?php echo get_template_directory_uri().'/assets/imgs/blog-6.jpg'; ?>" alt= "template by DevCRID http://www.devcrud.com/" class= "img-fluid radius-image" />
                            <div class="card-body">
